  ...
  return (
    <>
      <CookieConsent
        ...
        style={{ background: "#2B373B", position: "fixed", bottom: "0", zIndex: "1000" }}
        buttonStyle={{ color: "#4e503b", fontSize: "13px" }}
        declineButtonStyle={{ color: "#fff", background: "#f44336", fontSize: "13px" }}
        expires={150}
      >
        This website uses cookies to enhance the user experience. You can choose to accept or decline.
      </CookieConsent>
